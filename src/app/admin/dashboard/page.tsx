    ...
    return (
        <div className="flex flex-col gap-10">
            <div>
                ...
                <p className="text-ink/70 mt-2">Overview of platform activity.</p>
            </div>

            <section>
                <h2 className="text-xl font-bold text-ink mb-4">Statistics</h2>
            ...
            <section>
                <h2 className="text-xl font-bold text-ink mb-4">Today&apos;s Visitors</h2>
                <VisitorsPreview />
            </section>

            <section>
                <h2 className="text-xl font-bold text-ink mb-4">Promotions</h2>
                <PromotionsPreview />
            </section>
        </div>
    );
